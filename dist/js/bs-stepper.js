...
(function (global, factory) {
  ...
  var matches = typeof window !== 'undefined' ? window.Element.prototype.matches : undefined;
  ...
  var WinEvent = function WinEvent(inType, params) {
    return typeof window !== 'undefined' ? new window.Event(inType, params) : undefined;
  };

  var createCustomEvent = function createCustomEvent(eventName, params) {
    var cEvent = typeof window !== 'undefined' ? new window.CustomEvent(eventName, params) : undefined;
    return cEvent;
  };
  ...
  var getTransitionDurationFromElement = function getTransitionDurationFromElement(element) {
    ...
    var transitionDuration = typeof window !== 'undefined' ? window.getComputedStyle(element).transitionDuration : 0;
